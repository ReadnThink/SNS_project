...
public class PostController {
            ...
            , @AuthenticationPrincipal LoginUser loginUser)
    {
        ...
        commendGateway.request(new KafkaPostCreate(postCreate, loginUser.getUser().getUserId()));
    ...
    public ResponseEntity<ResponseDto<String>> edit(@ModelAttribute PostId postId, @RequestBody PostEdit postEdit
            , @AuthenticationPrincipal LoginUser loginUser)
    {
        commendGateway.request(new KafkaPostEdit(postEdit, postId, loginUser.getUser().getUserId()));
    ...
    public ResponseEntity<ResponseDto<String>> delete(@ModelAttribute PostId postId, @AuthenticationPrincipal LoginUser loginUser) {
        commendGateway.request(new KafkaPostDelete(postId, loginUser.getUser().getUserId()));
